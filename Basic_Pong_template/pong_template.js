...
export default class Pong extends THREE.Group {
    constructor(gameParameters, tableParameters, player1Parameters, player2Parameters, ballParameters) {
        ...
        */
        ...
        document.addEventListener("keyleft", event => this.keyChange(event, false));

        document.addEventListener("keyright", event => this.keyChange(event, false));
    ...
    update() {
        ...
        if (!this.gameRunning) {
            ...
            if (!this.gamePaused) {
                ...
                if (this.player2.score==10||this.player1.score==10) {
